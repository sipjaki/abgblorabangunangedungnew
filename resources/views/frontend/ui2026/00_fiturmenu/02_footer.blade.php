    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    <h4 class="footer-title">Bantuan Teknis</h4>
                    <ul class="footer-links">
                        <li><a href="#"><i data-lucide="chevron-right"></i>Pengajuan PBG</a></li>
                        <li><a href="#"><i data-lucide="chevron-right"></i>Pengajuan SLF</a></li>
                        <li><a href="#"><i data-lucide="chevron-right"></i>Pembongkaran Bangunan Gedung</a></li>
                        <li><a href="#"><i data-lucide="chevron-right"></i>Bantuan Asistensi</a></li>
                        <li><a href="#"><i data-lucide="chevron-right"></i>Peneliti Kontrak</a></li>
                        <li><a href="#"><i data-lucide="chevron-right"></i>Penyusutan Nilai</a></li>
                        <li><a href="#"><i data-lucide="chevron-right"></i>Pemeliharaan Bangunan </a></li>
                        <li><a href="#"><i data-lucide="chevron-right"></i>Perhitungan Konstruksi</a></li>
                        <li><a href="#"><i data-lucide="chevron-right"></i>Pendampingan Serah Terima</a></li>
                        <li><a href="#"><i data-lucide="chevron-right"></i>Personil Tim Teknis</a></li>
                    </ul>
                </div>
    ...
    <!-- JavaScript Files -->
  <script src="{{ asset('assets/uibaru/js/main.js') }}"></script>
<script src="{{ asset('assets/uibaru/js/dropdown.js') }}"></script>
<script src="{{ asset('assets/uibaru/js/counter.js') }}"></script>
