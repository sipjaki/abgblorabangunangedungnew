...
<section class="section services-section" id="services"
    ...
    <div style="
        ...
        opacity: 0.12; /* transparansi 12% -> lebih samar */
        pointer-events: none;
        z-index: 0;
    "></div>
...
<!-- Tambahkan CSS untuk efek animasi -->
<style>
    /* Grid layout */
    .services-grid {
        display: grid;
    ...
    /* Card styling dengan efek hover yang smooth */
    .service-card {
    ...
    /* Delay animasi berdasarkan data-delay */
    ...
    /* Hover efek tambahan untuk icon */
    .service-card {
...
<script>
    // Pastikan lucide icons ter-render dengan baik
