                                    ...
                                    <a href="#" class="text-decoration-none">
                                        <div class="card shadow-sm border-0 h-100">
                                            <div class="card-img-container">
                                                <img src="/assets/android/pbgslf/PBG_FUNGSI_PRASARANA.png" alt="PBG Fungsi Prasarana" class="card-img-top img-fluid" style="object-fit: cover; width: 100%; height: auto;">
                                            </div>
