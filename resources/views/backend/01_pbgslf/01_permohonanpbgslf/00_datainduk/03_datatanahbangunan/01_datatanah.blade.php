        ...
        <div class="col-12 mb-4 mt-5">
            <div class="card shadow-sm border-0 animate__animated animate__fadeInUp">
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    ...
                    {{-- <h5 style="font-size: 16px;" class="mb-0">Informasi Data Tanah : {{ $pemilik->isiandatatanah ?? 'Tidak Diketahui' }}</h5> --}}
                    <h5 style="font-size: 16px;" class="mb-0">Informasi Data Tanah </h5>
                </div>
    ...
    @empty
        <div class="col-12" style="margin-top: 50px;">
            ...
            <div class="text-center mt-4">
                <a href="{{ route('bepbgdatatanahcreate', $data->id) }}" class="button-baru">
    ...
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0">Informasi Permohonan Pengajuan</h5>
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/bepbgdatatanahdelete/" + encodeURIComponent(id);
