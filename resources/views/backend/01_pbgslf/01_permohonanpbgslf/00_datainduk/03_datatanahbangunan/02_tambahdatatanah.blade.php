...
<div class="text-center">
   ...
   <h5 class="text-primary fw-bold mt-2" style="font-size: 16px;">
    ...
    Informasi Data Tanah Bangunan Gedung
</h5>
</h5>
    <hr class="my-4" style="border-top: 2px dashed #0d6efd; width: 60%; margin: auto;">
</div>

<form id="formPemilik" action="{{ route('bepbgdatatanahnew') }}" method="POST">
    @csrf
    ...
    <label class="form-label d-block" style="color: black; font-weight: 600;">
        <i class="bi bi-file-text me-1" style="color: blue;"></i> Catatan Berkas 1
    </label>

    <textarea name="catatanberkas1" rows="3" class="form-control @error('catatanberkas1') is-invalid @enderror" style="padding: 12px;">
        {{ old('catatanberkas1') }}
    </textarea>
...
<br>
        ...
        <div class="col-12 text-end mt-3">
            <button type="button" class="button-hijau" onclick="openModal()">
                <i class="bi bi-save me-1"></i> Simpan Data Tanah
            </button>
        </div>
    </div>
</form>
...
<div id="confirmModal" style="display: none; position: fixed; inset: 0; background-color: rgba(0, 0, 0, 0.5); z-index: 1000; justify-content: center; align-items: center;">
    <div style="background: white; padding: 24px 30px; border-radius: 12px; max-width: 400px; width: 90%; text-align: center; box-shadow: 0 10px 25px rgba(0,0,0,0.2);">
        <p style="font-size: 16px; font-weight: 600; margin-bottom: 20px;">Apakah Anda ingin menambahkan data tanah untuk permohonan ini?</p>
