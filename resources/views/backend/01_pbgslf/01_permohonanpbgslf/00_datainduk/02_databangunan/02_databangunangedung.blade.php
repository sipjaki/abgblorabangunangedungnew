...
<div class="row g-4">
    @forelse ($subdatapemilik as $pemilik)
        @php
            $infoItems = [
                ['icon' => 'bi-journal-text', 'title' => 'Jenis Permohonan Konsultasi', 'value' => $pemilik->jenisperkonsultasi->jenis ?? '-'],
                ['icon' => 'bi-building', 'title' => 'Nama Bangunan', 'value' => $pemilik->namabangunan ?? '-'],
                ...
                ['icon' => 'bi-building', 'title' => 'Sub Fungsi Bangunan Gedung', 'value' => $pemilik->cadangan1 ?? '-'],
                ...
                ['icon' => 'bi-border-style', 'title' => 'GSB (Garis Sempadan Bangunan)', 'value' => $pemilik->gsb ?? '-'],
                ['icon' => 'bi-box', 'title' => 'KDB (Koefisien Dasar Bangunan)', 'value' => $pemilik->kdb ?? '-'],
                ['icon' => 'bi-bar-chart-steps', 'title' => 'KLB (Koefisien Lantai Bangunan)', 'value' => $pemilik->klb ?? '-'],
                ['icon' => 'bi-graph-up', 'title' => 'KDH (Koefisien Daerah Hijau)', 'value' => $pemilik->kdh ?? '-'],

                ['icon' => 'bi-geo', 'title' => 'Provinsi', 'value' => $pemilik->provinsi ?? '-'],
                ['icon' => 'bi-map', 'title' => 'Kabupaten', 'value' => $pemilik->kabupaten ?? '-'],
                ['icon' => 'bi-pin-map', 'title' => 'Kecamatan', 'value' => $pemilik->kecamatanblora->kecamatanblora ?? '-'],
                ['icon' => 'bi-geo-alt-fill', 'title' => 'Kelurahan/Desa', 'value' => $pemilik->kelurahandesa->desa ?? '-'],
                ['icon' => 'bi-signpost-2', 'title' => 'Alamat Lengkap', 'value' => $pemilik->alamatlengkap ?? '-'],
                ['icon' => 'bi-crosshair', 'title' => 'Koordinat', 'value' => $pemilik->koordinat ?? '-'],
        ...
        <div class="col-12 mb-4 mt-5">
            <div class="card shadow-sm border-0 animate__animated animate__fadeInUp">
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    ...
                    <h5 style="font-size: 16px;" class="mb-0">Informasi Data Bangunan Gedung : {{ $pemilik->namabangunan ?? 'Tidak Diketahui' }}</h5>
                </div>
    ...
    @empty
        <div class="col-12" style="margin-top: 50px;">
            ...
            ">
                ...
                Data Bangunan Gedung Tidak Ditemukan !!
            </div>
            <div class="text-center mt-4">
                <a href="{{ route('bepbgdatabangunancreate', $data->id) }}" class="button-baru">
                    <i class="bi bi-plus me-1"></i> Tambahkan Data
                </a>
            </div>
        </div>
    @endforelse
    ...
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0">Informasi Permohonan Pengajuan</h5>
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/bepbgdatabangunandelete/" + encodeURIComponent(id);
