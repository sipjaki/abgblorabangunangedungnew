...
<div class="row g-4 mt-2 align-items-end">
        ...
        <div class="col-md-4">
            <label class="form-label fw-semibold text-dark">
                <i class="bi bi-calendar-event text-primary me-1"></i> Tanggal Pemberitahuan
            </label>
            <input type="date" name="tanggalpemberitahuan"
                class="form-control @error('tanggalpemberitahuan') is-invalid @enderror"
                value="{{ old('tanggalpemberitahuan') }}">
            @error('tanggalpemberitahuan')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
       ...
       <div class="col-md-4">
    <label class="form-label fw-semibold text-dark">
        <i class="bi bi-123 text-primary me-1"></i> Pemberitahuan Ke
    </label>
    <select name="pemberitahuanke" class="form-select @error('pemberitahuanke') is-invalid @enderror">
        <option value="" disabled {{ old('pemberitahuanke') ? '' : 'selected' }}>-- Pilih Pemberitahuan Ke --</option>
        @for ($i = 1; $i <= 10; $i++)
            <option value="{{ $i }}" {{ old('pemberitahuanke') == $i ? 'selected' : '' }}>{{ $i }}</option>
        @endfor
    </select>
    @error('pemberitahuanke')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
    ...
    {{-- Catatan (penuh) --}}
    <div class="row mt-3" id="catatan-field" style="{{ old('pilihancatatan') === 'tidak lengkap' ? '' : 'display:none;' }}">
        <div class="col-12">
            <label class="form-label fw-semibold text-dark">
                <i class="bi bi-journal-text text-primary me-1"></i> Catatan
            </label>
            <textarea name="catatan" rows="3"
                class="form-control @error('catatan') is-invalid @enderror"
                placeholder="Tuliskan catatan tambahan...">{{ old('catatan') }}</textarea>
            @error('catatan')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
