        ...
        <div class="col-12 mb-4 mt-5">
            <div class="card shadow-sm border-0 animate__animated animate__fadeInUp">
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    ...
                    <h5 class="mb-0" style="font-size: 16px;">Informasi Data Dokumen Teknis Struktur Bangunan Gedung</h5>
                </div>
    ...
    @empty
        <div class="col-12" style="margin-top: 50px;">
            ...
            ">
                ...
                Dokumen Data Teknis Struktur Tidak Ditemukan !!
            </div>

            {{-- Tombol Tambah Data --}}
            <div class="text-center mt-4">
                <a href="{{ route('bepbgdokumeteknisstrkcreate', $data->id) }}" class="button-baru">
...
function setDeleteUrl(button) {
    ...
    document.getElementById('deleteForm').action = `/bepbgdokumeteknisstrkdelete/${id}`;
}
</script>
                 <style>
                     .table-responsive {
