...
@include('backend.00_administrator.00_baganterpisah.10_selamatdatang')
           ...
           {{-- <div class="form-modern col-sm-12"><h3 class="mb-0">Selamat datang ! <span style="color: black; font-weight:800;" > {{ Auth::user()->name }}</span> di Dashboard <span style="color: black; font-weight:800;"> {{ Auth::user()->statusadmin->statusadmin }} </span>  Sistem Informasi Pembina Jasa Konstruksi Kab Blora</h3></div> --}}
...
<div class="row g-4">
                ...
                <div class="card-body bg-white rounded-3" style="background: linear-gradient(to bottom, #f8faff, #e6f0ff);">
                    <div class="row g-3">
                        ...
                        @if (strtolower($pemilik->pilihancatatan) === 'tidak lengkap')
                            <div class="form-modern col-12 mt-3">
    ...
    @empty
        <div class="form-modern col-12" style="margin-top: 50px;">
            <div style="
                width: 100%;
                display: flex;
            ...
            ">
                ...
                Informasi Data Umum Tidak Ditemukan !!
            </div>

            {{-- Tombol Tambah Data --}}
            <div class="text-center mt-4">
                <a href="{{ route('bepbgdataumumcreate', $data->id) }}" class="button-baru">
    ...
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0">Informasi Permohonan Pengajuan</h5>
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/bepbgdataumumdelete/" + encodeURIComponent(id);
