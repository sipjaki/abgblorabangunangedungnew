...
<div class="text-center">
   ...
   <h5 class="text-primary fw-bold mt-2" style="font-size: 16px;">
    ...
    Perbaikan Informasi Data Bangunan Gedung
</h5>
</h5>
...
<form id="formPemilik" action="{{ route('updatedatabangunannew', $data->id) }}" method="POST">
    ...
    <div class="row g-3 mt-2">
        ...
        <div class="form-modern col-md-6">
            <label class="form-label-modern"><i class="bi bi-house-fill text-primary me-1"></i> Nama Bangunan Gedung</label>
        ...
        <div class="form-modern col-md-6">
    <label class="form-label-modern">
        <i class="bi bi-building text-primary me-1"></i> Sub Fungsi Bangunan
    </label>
    <input type="text"
           name="cadangan1"
           class="form-control @error('cadangan1') is-invalid @enderror"
           value="{{ $data->cadangan1 ?? old('cadangan1') }}">
    @error('cadangan1')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
    </div>
        ...
        <div class="row">
            ...
            <div class="form-modern col-md-6 mb-3">
                ...
                <input type="text" name="gsb" class="form-control bg-light" value="{{ $data->gsb }}">
            </div>
            ...
            <div class="form-modern col-md-6 mb-3">
                ...
                <input type="text" name="kdb" class="form-control bg-light" value="{{ $data->kdb }}">
            </div>
            ...
            <div class="form-modern col-md-6 mb-3">
                ...
                <input type="text" name="klb" class="form-control bg-light" value="{{ $data->klb }}">
            </div>
            ...
            <div class="form-modern col-md-6 mb-3">
                ...
                <input type="text" name="kdh" class="form-control bg-light" value="{{ $data->kdh }}">
            </div>
        </div>
        ...
        <div class="row g-3">
            ...
            <div class="form-modern col-md-4">
                ...
                <input type="text" class="form-control bg-light" value="{{ $data->kelurahandesa->desa ?? '' }}" readonly>
        ...
        {{-- Catatan --}}
        <div class="form-modern col-12" id="catatan-field" style="display: {{ ($data->pilihancatatan === 'tidak lengkap' || old('pilihancatatan') === 'tidak lengkap') ? 'block' : 'none' }};">
