...
<form id="formPemilik" action="{{ route('bepbgdokumeteknismepcreatenew') }}" method="POST">
    @csrf
...
<div class="row g-3 mt-2">
    @php
    $berkasList = [
        '1. Spesifikasi Teknis Mekanikal, Elektrikal, dan Plambing',
        '2. Perhitungan Teknis Mekanikal, Elektrikal, dan Plambing',
        '3. Gambar Rencana Dan Detail Sistem Proteksi Kebakaran',
        '4. Gambar Rencana Dan Detail Pengelolaan Persampahan',
...
<div id="confirmModal" style="display: none; position: fixed; inset: 0; background-color: rgba(0, 0, 0, 0.5); z-index: 1000; justify-content: center; align-items: center;">
    <div style="background: white; padding: 24px 30px; border-radius: 12px; max-width: 400px; width: 90%; text-align: center; box-shadow: 0 10px 25px rgba(0,0,0,0.2);">
        <p style="font-size: 16px; font-weight: 600; margin-bottom: 20px;">Apakah Anda ingin menambahkan data dokumen teknis MEP untuk permohonan ini?</p>
