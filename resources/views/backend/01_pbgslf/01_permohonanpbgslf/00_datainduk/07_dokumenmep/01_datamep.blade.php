    ...
    @empty
        <div class="col-12" style="margin-top: 50px;">
            ...
            ">
                ...
                Dokumen Data Teknis MEP Tidak Ditemukan !!
            </div>

            {{-- Tombol Tambah Data --}}
            <div class="text-center mt-4">
                <a href="{{ route('bepbgdokumeteknismepcreate', $data->id) }}" class="button-baru">
...
function setDeleteUrl(button) {
    ...
    document.getElementById('deleteForm').action = `/bepbgdokumeteknismepdelete/${id}`;
}
</script>
                 <style>
                     .table-responsive {
