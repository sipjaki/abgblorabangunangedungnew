...
<div class="col-md-6">
    <div class="mb-3">
        ...
        <select
            id="jenispengajuanpbgslfper_id"
            name="jenispengajuanpbgslfper_id"
            class="form-select @error('jenispengajuanpbgslfper_id') is-invalid @enderror"
        >
            <option value="">-- Pilih Jenis Pengajuan --</option>
       @foreach ($datapbgslf as $value)
    <option value="{{ $value->id }}" {{ old('jenispengajuanpbgslfper_id', $data->jenispengajuanpbgslfper_id ?? '') == $value->id ? 'selected' : '' }}>
        {{ $value->jenispengajuan }}
    </option>
@endforeach

        </select>
        @error('jenispengajuanpbgslfper_id')
...
<div class="col-md-6">
    <div class="mb-3">
        ...
        <input
            ...
            id="noregissimbg"
            name="noregissimbg"
            value="{{ old('noregissimbg', $data->noregissimbg ?? '') }}"
