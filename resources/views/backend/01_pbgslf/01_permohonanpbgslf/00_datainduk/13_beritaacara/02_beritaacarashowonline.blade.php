...
<div style="border: 1px solid #000; min-height: {{ 100 + (12 - $jumlahBaris) * 20 }}px; padding: 8px; margin-top:-15px; font-family: 'Times New Roman', serif !important; font-size: 14px;">
</div>
<br>
    ...
    <tbody>
        @foreach ($listPengawas as $index => $row)
            <tr>
                ...
                <td style="border: 1px solid #000; padding: 3px; font-family: 'Times New Roman', serif !important; font-size: 12px; width:40px;"></td>
