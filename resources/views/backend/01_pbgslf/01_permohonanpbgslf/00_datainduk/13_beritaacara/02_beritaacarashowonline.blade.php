...
<table style="width: 100%; border-collapse: collapse; font-size: 14px; font-family: 'Times New Roman', serif !important; margin-top: -15px;">
    ...
    <td rowspan="{{ $jumlahBaris }}" style="border: 1px solid #000; padding: 5px; text-align: center; vertical-align: middle;">
        <div style="font-family: 'Times New Roman', serif !important; font-size: 14px; line-height: 1.5;">
            ...
            <br>
            <div style="font-family: 'Times New Roman', serif !important; font-size: 14px;"><strong><u>HARTONO GUNTUR R, ST, MT</u></strong></div>
            <div style="font-family: 'Times New Roman', serif !important; font-size: 14px;"><strong>Ketua</strong></div>
        </div>
    </td>
@endif
