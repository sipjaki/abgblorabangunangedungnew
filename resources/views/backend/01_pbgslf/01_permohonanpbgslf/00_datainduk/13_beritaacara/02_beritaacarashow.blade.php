                        ...
                        <div class="card-body">
                            ...
                            <div class="halaman">
                                ...
                                <div style="font-family: 'Times New Roman', serif; font-size: 12px; line-height: 1.0; margin-bottom:4px;">
                                    ...
                                    <div class="force-times" style="border: 1px solid #000; min-height: {{ 175 + (12 - $jumlahBaris) * 20 }}px; padding: 8px; margin-top:-15px; font-size: 14px; font-family: 'Times New Roman', Times, serif;">
                                    </div>
                                    <br>
