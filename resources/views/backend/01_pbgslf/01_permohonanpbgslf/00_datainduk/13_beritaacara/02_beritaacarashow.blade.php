        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="mb-0">Berita Acara Konsultasi</h3>
                        </div>
                    </div>
                    <!--end::Row-->
                </div>
                            ...
                            <div class="halaman">
                                <div class="kop" style="margin-top: -55px;">
                                    ...
                                    <div style="display: inline-block;">
                                        <h3 style="font-size: 18px; margin: 0;">PEMERINTAH KABUPATEN BLORA</h3>
                                        <h3 style="font-size: 18px; margin: 0;">DINAS PEKERJAAN UMUM DAN PENATAAN RUANG</h3>
                                        <p style="font-size: 18px; margin: 0;">Jl. Nusantara No. 62 Telp. (0296) 531004</p>
                                        <h3 style="font-size: 18px; margin: 0;">BLORA 58214</h3>
                                    </div>
                                ...
                                <div style="font-family: 'Times New Roman', serif; font-size: 12px; line-height: 1.5;">
                                    ...
                                    <table style="width: 100%; border-collapse: collapse; font-size: 14px; margin-top:5px;">
                                        <tr>
                                            <td style="width: 35%; border: 1px solid #000; padding: 2px; font-size: 14px;">
                                                No. Registrasi
                                            </td>
                                            <td style="border: 1px solid #000; padding: 2px; font-size: 14px;">
                                    ...
                                    <table style="width: 100%; border: 1px solid #000; border-collapse: collapse; font-size: 14px; margin-top: -10px;">
                                        <thead>
                                            <tr>
                                                <th style="border: 1px solid #000; padding: 1.75px; text-align:center; font-size: 14px;">
                                                    No
                                                </th>
                                                <th style="border: 1px solid #000; padding: 1.75px; text-align:center; font-size: 14px;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="border: 1px solid #000; text-align: center; padding: 1.75px; font-size: 14px;">1</td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;">Pemeriksaan Arsitektur</td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                            </tr>
                                            <tr>
                                                <td style="border: 1px solid #000; text-align: center; padding: 1.75px; font-size: 14px;">2</td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;">Pemeriksaan Struktur</td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                            ...
                                            <tr>
                                                <td style="border: 1px solid #000; text-align: center; padding: 1.75px; font-size: 14px;">3</td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;">Pemeriksaan M E P</td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                            ...
                                            <tr>
                                                <td style="border: 1px solid #000; text-align: center; padding: 1.75px; font-size: 14px;">4</td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;">Data Teknis Gedung Eksisting</td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                                <td style="border: 1px solid #000; padding: 1.75px; font-size: 14px;"></td>
                                    ...
                                    <p>
                                        <strong style="margin-top: 5px; font-size: 14px;">Catatan:</strong>
                                    </p>
                                    <div style="border: 1px solid #000; min-height: {{ 140 + (12 - $jumlahBaris) * 20 }}px; padding: 8px; margin-top:-15px; font-size: 14px;">
                                    </div>
                                    <br>
                                    ...
                                    <table style="width: 100%; border-collapse: collapse; font-size: 14px; margin-top: -15px;">
                                        <thead>
                                            <tr>
                                                <th style="border: 1px solid #000; text-align: center; padding: 3px; width: 125px; font-size: 14px;">
                                                    Pemohon
                                                </th>
                                                <th style="border: 1px solid #000; text-align: center; padding: 3px; font-size: 14px;">
                                                    Pengawas
                                                </th>
                                                <th style="border: 1px solid #000; text-align: center; padding: 3px; font-size: 14px;">
                                                    TTD
                                        ...
                                        <tbody>
                                            @foreach ($listPengawas as $index => $row)
                                                <tr>
                                                    @if ($index === 0)
                                                        <td style="border: 1px solid #000; padding: 3px; font-size: 14px;" rowspan="{{ $jumlahBaris }}"></td>
                                                    @endif
                                                    <td style="border: 1px solid #000; padding: 3px; font-size: 14px;">
                                                        {{ $row['no'] }}. {{ $row['pengawas'] }}
                                                    </td>
                                                    <td style="border: 1px solid #000; padding: 3px; font-size: 14px;"></td>
                                                    <td style="border: 1px solid #000; padding: 3px; font-size: 14px;">
                                                        {{ $row['no'] }}. {{ $row['tpa'] }}
                                                    </td>
                                                    <td style="border: 1px solid #000; padding: 3px; font-size: 14px;"></td>
