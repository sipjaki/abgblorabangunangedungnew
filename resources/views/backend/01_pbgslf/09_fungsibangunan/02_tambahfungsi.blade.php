...
<br>
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                  <form action="{{ route('befungsibangunancreatenew') }}" method="POST" enctype="multipart/form-data">
          @csrf
                            <!-- begin::Body -->
                            <div class="card-body">
                                <div class="row">
...
<div class="row">
  <div class="col-md-6">
    <div class="form-modern mb-3">
      <label class="form-label-modern" for="fungsi">
        <i class="bi bi-geo-alt" style="margin-right: 8px; color: navy;"></i> Fungsi Bangunan Gedung
      </label>
      <input
        type="text"
        id="fungsi"
        name="fungsi"
        {{-- value="{{ old('fungsi', $data->fungsi ?? '') }}" --}}
