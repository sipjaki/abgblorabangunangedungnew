...
<a href="{{ url('/beserahterima') }}" class="button-newvalidasi" style="cursor: pointer; margin-left:10px; color:black; display: inline-flex; align-items: center; text-decoration: none;">
