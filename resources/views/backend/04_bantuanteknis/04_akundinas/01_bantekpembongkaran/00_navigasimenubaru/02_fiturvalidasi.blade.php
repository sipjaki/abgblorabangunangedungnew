            ...
            <td style="text-align: center; padding: 16px;">
                <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 12px;">
                    ...
                    @if($data->validasiberkas2 == 'sudah')
                        <button class="button-lolos" type="button" onclick="openModal10({{ $data->id }})" style="background-color: #10B981; color: black;" >
                            <i class="bi bi-patch-check-fill me-1"></i> Lolos
                        </button>
                    @elseif($data->validasiberkas2 == 'belum')
                        <button class="button-dikembalikan" type="button" onclick="openModal10({{ $data->id }})" style="background-color: #0400ff; color: black;">
