...
<script>
    ...
    // Hapus event klik, jadi marker tidak bisa berpindah
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                 <form action="{{ route('barekomtekberkas.upload', $data->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                            <!-- begin::Body -->
                            <div class="card-body">
...
<div class="text-center">
    ...
    <h5 style="color: #0d6efd; font-weight: bold; margin-top: 5px; font-size:16px;">
        ...
        Upload Berita Acara Rekomendasi Teknis Pembongkaran Bangunan Gedung
    </h5>
    <hr class="my-4" style="border-top: 2px dashed #0d6efd; width: 60%; margin: auto;">
</div>
...
<div class="row">
    ...
    <div class="form-modern col-md-6 mb-3">
        ...
        <input type="text"
               name="nomorsuratrekom"
               class="form-control @error('nomorsuratrekom') is-invalid @enderror"
               value="{{ old('nomorsuratrekom', $data->nomorsuratrekom ?? '') }}"
               placeholder="Masukkan Nomor Surat Rekomendasi">
        @error('nomorsuratrekom')
...
<div class="mb-3">
    ...
    <div class="mt-3" id="previewContainerProposal" style="{{ isset($data->cadangan2) ? '' : 'display: none;' }}">
        <label class="fw-bold">Berita Acara Rekomtek</label>
        <iframe id="iframeProposal" src="{{ isset($data->cadangan2) ? asset($data->cadangan2) : '' }}"
            style="width: 100%; height: 400px; border: 1px solid #ccc; border-radius: 6px;"></iframe>
    </div>
    <div id="msgProposal" class="mt-3"
        style="color: grey; font-style: italic; {{ isset($data->cadangan2) ? 'display:none;' : '' }}">
                                ...
                                <div id="confirmModal" style="display: none; position: fixed; inset: 0; background-color: rgba(0, 0, 0, 0.5); z-index: 1000; justify-content: center; align-items: center;">
                                    <div style="background: white; padding: 24px 30px; border-radius: 12px; max-width: 400px; width: 90%; text-align: center; box-shadow: 0 10px 25px rgba(0,0,0,0.2);">
                                      <p style="font-size: 16px; font-weight: 600; margin-bottom: 20px;">
                                        Apakah Anda ingin upload BA Rekomtek?
                                    </p>
