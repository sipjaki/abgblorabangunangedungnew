<div class="container-fluid mt-4 px-4">
    ...
    <!-- TOMBOL NAVIGASI & AKSI (DI LUAR AREA CETAK) -->
    <div class="d-flex justify-content-end gap-2 mb-4 d-print-none">
        ...
        <!-- Tombol untuk melihat pratinjau via Modal -->
        <button type="button" class="btn btn-info shadow-sm fw-bold text-white" data-bs-toggle="modal" data-bs-target="#modalPreviewCetak">
            <i class="bi bi-eye-fill me-1"></i> Preview PDF
        </button>
        <!-- Tombol untuk langsung download -->
        <button onclick="prosesUnduhPDF()" class="btn btn-primary shadow-sm fw-bold">
            <i class="bi bi-file-earmark-pdf-fill me-1"></i> Download PDF
        </button>
    </div>

    <!-- ======================================================= -->
    <!-- AREA UTAMA: TAMPIL SEMUA DATA DI HALAMAN WEB            -->
    <!-- BUNGKUSAN CLASS: halaman-downloadperhitungan            -->
    <!-- ======================================================= -->
    <div id="area-cetak-langsung" class="halaman-downloadperhitungan mx-auto shadow-sm">
        ...
        <div class="halaman-pdf-page">
            ...
            <!-- TABEL FORM PENILAIAN (FIX FIXED LAYOUT & ANTI OFFSIDE) -->
            <table class="table-form-utama w-100 mb-3">
                <thead>
                    <tr>
                        <th rowspan="3" style="width: 3%;">NO</th>
                        <th rowspan="3" style="width: 12%;">KOMPONEN STANDAR</th>
                        <th rowspan="3" style="width: 5%;">Bobot</th>
                        <th rowspan="2" style="width: 16%;">TAHAP 1 - PENGAMATAN VISUAL ADA/TIDAKNYA KERUSAKAN DAN INDIKASI DAMPAK KESELAMATAN PEMANFAATAN RUANGAN/BANGUNAN</th>
                        <th colspan="5" style="width: 25%;">TAHAP 2 - KLASIFIKASI KERUSAKAN BERDASARKAN KLASIFIKASI KERUSAKAN</th>
                        <th colspan="7" style="width: 28%;">PERHITUNGAN TINGKAT KERUSAKAN KOMPONEN</th>
                        <th rowspan="3" style="width: 11%;">TINGKAT KERUSAKAN<br>(11)</th>
                    </tr>
                    <tr>
                        <th style="width: 5%;">Tidak Rusak</th>
                        <th style="width: 5%;">Ringan</th>
                        <th style="width: 5%;">Sedang</th>
                        <th style="width: 5%;">Berat</th>
                        <th style="width: 5%;">Tdk Sesuai</th>
                ...
                <tbody>
                    ...
                    @foreach($komponenData as $key => $item)
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ number_format($bobot * 100, 0) }}%</td>
...
<!-- ======================================================= -->
<!-- MODAL POPUP PREVIEW ONLY                                -->
<!-- ======================================================= -->
<div class="modal fade" id="modalPreviewCetak" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header bg-dark text-white py-2">
                <h6 class="modal-title"><i class="bi bi-eye"></i> Preview Hasil Cetak (A4 Landscape)</h6>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body bg-secondary p-3 d-flex justify-content-center" style="overflow-y: auto;">
                <!-- Mengkloning isi dari halaman-downloadperhitungan secara real-time -->
                <div id="area-preview-modal" class="bg-white shadow-lg p-3" style="width: 297mm; min-height: 210mm; transform: scale(0.95); transform-origin: top center;">
                    <!-- Konten di-copy lewat javascript -->
                </div>
            </div>
...
<script>
// Fungsi menyalin konten real-time ke jendela modal pratinjau saat modal dibuka
document.getElementById('modalPreviewCetak').addEventListener('show.bs.modal', function () {
    const sumberData = document.getElementById('area-cetak-langsung').innerHTML;
    document.getElementById('area-preview-modal').innerHTML = sumberData;
});

function prosesUnduhPDF() {
    // Membidik element via Class .halaman-downloadperhitungan
    ...
    // Eksekusi generator PDF
    html2pdf().set(opt).from(element).save();
}
</script>

<style>
    /* STYLING ANTI OFFSIDE KELAS UTAMA */
    .halaman-downloadperhitungan {
        width: 297mm; /* Kunci lebar kertas A4 Landscape */
        max-width: 100%;
    ...
    /* FIXING LAYOUT TABEL UTAMA SUPAYA TIDAK MELEBAR */
    .table-form-utama {
        table-layout: fixed; /* MENGUNCI LEBAR TABEL SECARA MATEMATIS */
    ...
    .table-form-utama th, .table-form-utama td {
        ...
        text-align: center;
        overflow: hidden;
        word-wrap: break-word; /* Memotong kata panjang agar ke bawah */
        white-space: normal;  /* Mencegah teks mendorong tabel keluar */
    }
    .table-form-utama th {
        font-size: 8px;
