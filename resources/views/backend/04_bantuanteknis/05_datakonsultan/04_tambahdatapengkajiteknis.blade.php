...
<br>
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                  <form action="{{ route('bepengkajiteknisnewcreate') }}" method="POST" enctype="multipart/form-data">
          @csrf
                            <!-- begin::Body -->
                            <div class="card-body">
    ...
    <div class="col-md-6">
        ...
        <div class="form-modern mb-3">
            ...
            <input
                ...
                id="direktur"
                name="direktur"
                value="{{ old('direktur', $data->direktur ?? '') }}"
                class="form-control @error('direktur') is-invalid @enderror"
        ...
        <div class="form-modern mb-3">
            ...
            <textarea
                id="subklasifikasi"
                name="subklasifikasi"
                class="form-control @error('subklasifikasi') is-invalid @enderror"
                rows="3"
                placeholder="Masukkan subklasifikasi">{{ old('subklasifikasi', $data->subklasifikasi ?? '') }}</textarea>
        ...
        <div class="form-modern mb-3">
            ...
            <textarea
                ...
                rows="3"
                placeholder="Masukkan pengalaman">{{ old('pengalaman', $data->pengalaman ?? '') }}</textarea>
            @error('pengalaman')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
                                ...
                                <div id="confirmModal" style="display: none; position: fixed; inset: 0; background-color: rgba(0, 0, 0, 0.5); z-index: 1000; justify-content: center; align-items: center;">
                                    <div style="background: white; padding: 24px 30px; border-radius: 12px; max-width: 400px; width: 90%; text-align: center; box-shadow: 0 10px 25px rgba(0,0,0,0.2);">
                                      <p style="font-size: 16px; font-weight: 600; margin-bottom: 20px;">
                                        Apakah Anda ingin menambahkan konsultan pengkaji teknis ?
                                    </p>
