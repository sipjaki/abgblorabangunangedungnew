...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px; flex-wrap: wrap; gap: 10px;">
  ...
  <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
    ...
    <a href="/beartikelcreate" style="text-decoration: none;">
      <button
        class="button-baru">
        <i class="bi bi-plus me-2"></i> Buat Artikel
      </button>
    </a>
  </div>
  ...
  function searchTable() {
    ...
    <table id="tabelSuratbantuanteknis" class="zebra-table" style="border-collapse: separate; border-spacing: 0; border-radius: 20px; overflow: hidden;">
             <thead>
                                  <tr>
     <th style="">No</th>
<th style=""><i class="fas fa-user"></i> Judul </th>
<th style=""><i class="fas fa-heading"></i> Keterangan</th>
<th style=""><i class="fas fa-calendar-alt"></i> Berkas</th>
<th style=""><i class="fas fa-align-left"></i> Foto 1</th>
<th style=""><i class="fas fa-image"></i> Foto 2</th>
<th style=""><i class="fas fa-image"></i> Foto 3</th>

<th style=""><i class="fas fa-cogs"></i> Aksi</th>
