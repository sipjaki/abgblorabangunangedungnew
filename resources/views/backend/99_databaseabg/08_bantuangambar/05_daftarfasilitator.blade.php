...
<div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px; margin-bottom: 10px;">
  ...
  <div style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap;">
    ...
    <div style="position: relative; display: inline-block;">
      <input type="search" id="searchInput" placeholder="Cari Fasilitator...." onkeyup="searchTable()"
  ...
  <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
    <button onclick="exportTableToExcel('tabelSuratbantuanteknis', 'data_daftarfasilitatorbantuangambar')"
      class="button-baru"
    ...
    <a href="/datafasilitatorcreate" style="text-decoration: none;">
...
<script>
  ...
  function searchTable() {
    ...
    fetch(`/datafasilitator?search=${input}`)
...
<th style="background-color: #ADD8E6;">
    <i class="bi bi-person-vcard-fill" style="color: navy; font-size: 16px;"></i> Nama Lengkap
</th>
<th style="background-color: #ADD8E6;">
    <i class="bi bi-geo-alt-fill" style="color: navy; font-size: 16px;"></i> Alamat
</th>
<th style="background-color: #ADD8E6;">
    <i class="bi bi-card-heading" style="color: navy; font-size: 16px;"></i> NIK
</th>
<th style="background-color: #ADD8E6;">
    <i class="bi bi-briefcase-fill" style="color: navy; font-size: 16px;"></i> Jabatan
</th>

<th style="background-color: #ADD8E6; width:50px;"><i class="fas fa-tools"></i> Aksi</th>
            ...
            <td style="text-align: center; vertical-align: middle;">
                {{-- <a href="/404" class="btn btn-sm btn-info me-2" title="Show">
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/datafasilitatordelete/" + encodeURIComponent(id);
