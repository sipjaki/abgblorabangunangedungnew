...
<div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px; margin-bottom: 10px;">
  ...
  <div style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap;">
    ...
    <div style="position: relative; display: inline-block;">
      <input type="search" id="searchInput" placeholder="Cari Fungsi...." onkeyup="searchTable()"
  ...
  <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
    <button onclick="exportTableToExcel('tabelSuratbantuanteknis', 'data_daftarfungsibangunan')"
      class="button-baru"
    ...
    <a href="/datafungsibangunancreate" style="text-decoration: none;">
...
<script>
  ...
  function searchTable() {
    ...
    fetch(`/datafungsibangunan?search=${input}`)
...
<th style="background-color: #ADD8E6;">
    <i class="bi bi-list-check" style="color: navy; font-size: 16px;"></i> Fungsi Bangunan
</th>
            ...
            <td style="text-align: center; vertical-align: middle;">
                {{-- <a href="/404" class="btn btn-sm btn-info me-2" title="Show">
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/datafungsibangunandelete/" + encodeURIComponent(id);
