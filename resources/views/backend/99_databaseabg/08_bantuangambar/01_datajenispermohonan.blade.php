...
<th style="background-color: #ADD8E6;">
    <i class="bi bi-list-check" style="color: navy; font-size: 16px;"></i> Jenis
</th>
<th style="background-color: #ADD8E6; width:100px;"><i class="fas fa-tools"></i> Aksi</th>
            ...
            <td style="text-align: center; vertical-align: middle;">
                {{-- <a href="/404" class="btn btn-sm btn-info me-2" title="Show">
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/datajenispermohonandelete/" + encodeURIComponent(id);
