...
<br>
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                  <form action="{{ route('datajenispermohonancreatenew') }}" method="POST" enctype="multipart/form-data">
          @csrf
                            <!-- begin::Body -->
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-modern mb-3">
            <label class="form-label-modern" for="jenis">
                <i class="bi bi-list-check" style="margin-right: 8px; color: navy;"></i> Jenis Permohonan
            </label>
            <input
                type="text"
                id="jenis"
                ...
                placeholder="Contoh: Permohonan IMB, SLF, atau lainnya"
            >
            @error('jenis')
                                ...
                                <div id="confirmModal" style="display: none; position: fixed; inset: 0; background-color: rgba(0, 0, 0, 0.5); z-index: 1000; justify-content: center; align-items: center;">
                                    <div style="background: white; padding: 24px 30px; border-radius: 12px; max-width: 400px; width: 90%; text-align: center; box-shadow: 0 10px 25px rgba(0,0,0,0.2);">
                                      <p style="font-size: 16px; font-weight: 600; margin-bottom: 20px;">
                                        Apakah Anda ingin menambahkan jenis permohonan ?
                                    </p>
