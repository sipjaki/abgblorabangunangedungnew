...
<div class="row">
    ...
    <div class="col-md-4 mb-3">
        ...
        <select id="hasilinspeksi" name="hasilinspeksi"
                class="form-select @error('hasilinspeksi') is-invalid @enderror">
            <option value="">-- Pilih Hasil --</option>
            <option value="Lengkap" {{ old('hasilinspeksi') == 'Lengkap' ? 'selected' : '' }}>Lengkap</option>
            <option value="Tidak Lengkap" {{ old('hasilinspeksi') == 'Tidak Lengkap' ? 'selected' : '' }}>Tidak Lengkap</option>
        </select>
        @error('hasilinspeksi')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
