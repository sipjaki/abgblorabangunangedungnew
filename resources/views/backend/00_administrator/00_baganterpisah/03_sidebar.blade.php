...
{{-- <li class="nav-item">
    ...
    <ul class="nav nav-treeview" style="margin-left: 15px;">
        <!-- Submenu: Asistensi -->
        <li class="nav-item">
            <a href="/bebantekpembongkaran" class="nav-link">
                <!-- Icon Clipboard (Asistensi) -->
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="nav-icon" viewBox="0 0 16 16">
                    <path d="M10 1.5v1h3a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1v-10a1 1 0 0 1 1-1h3v-1A1.5 1.5 0 0 1 7.5 0h1A1.5 1.5 0 0 1 10 1.5zM6 1.5V3h4V1.5a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5z"/>
                </svg>
                <p style="color: white; margin-left: 8px;">Pembongkaran</p>
            </a>
        </li>
        ...
        <li class="nav-item">
            ...
            <a href="/bebantekanalisabgn" class="nav-link">
                <!-- Icon File EarMark (Permohonan) -->
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="nav-icon" viewBox="0 0 16 16">
                    <path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h6.5L14 4.5zM9.5 0v4a1 1 0 0 0 1 1h4l-5-5z"/>
                </svg>
        ...
        <li class="nav-item" style="color: red">
            <a href="/404" class="nav-link">
                ...
                <p style="color: red; margin-left: 8px;">Peneliti Kontrak</p>
            </a>
        </li>
        ...
        <li class="nav-item" style="color: red">
            <a href="/404" class="nav-link">
                ...
                <p style="color: red; margin-left: 8px;">Penyusutan</p>
            </a>
        </li>
        ...
        <li class="nav-item" style="color: red">
            <a href="/404" class="nav-link">
                ...
                <p style="color: red; margin-left: 8px;">Pemeliharaan </p>
            </a>
        </li>
        ...
        <li class="nav-item" style="color: red">
            <a href="/404" class="nav-link">
                ...
                <p style="color: red; margin-left: 8px;">Konstruksi</p>
            </a>
        </li>
        ...
        <li class="nav-item" style="color: red">
            <a href="/404" class="nav-link">
                ...
                <p style="color: red; margin-left: 8px;">Pendampingan</p>
            </a>
        </li>
        ...
        <li class="nav-item" style="color: red">
            <a href="/404" class="nav-link">
                ...
                <p style="color: red; margin-left: 8px;">Tim Teknis</p>
            </a>
        </li>
    ...
    <a href="/bepbgslfinformasi" class="nav-link">
        ...
        <li class="nav-item">
            <a href="/bedataperkonsultan" class="nav-link" style="display: flex; align-items: center;">
                ...
                <p style="color: white; margin-left: 8px; font-size: 16px; margin-bottom: 0;">Long List Baru <br>
                </p>
            </a>
        </li>
...
<ul class="nav nav-treeview" style="margin-left: 15px;">
    ...
    <p style="
        ...
        box-shadow: 1px 1px 3px rgba(0,0,0,0.2);
    ">
        <i class="bi bi-grid-1x2-fill" style="margin-right: 6px;"></i> Main Menu <br> Bantek Dinas
    </p>
</div>
...
<li class="nav-item">
    <a href="/ttdkepaladinasblora" class="nav-link" style="display: flex; align-items: center;">
        <i class="bi bi-building nav-icon" style="color: white; font-size: 16px; flex-shrink: 0;"></i>
        <p style="color: white; margin: 0 0 0 8px;">Ttd Kepala Dinas</p>
    </a>
</li>
...
<li class="nav-item">
    <a href="/datapbgpembongkaranpenilik" class="nav-link" style="display: flex; align-items: center;">
        <i class="bi bi-file-earmark-text nav-icon" style="color: white; font-size: 16px; flex-shrink: 0;"></i>
...
<li class="nav-item">
    <a href="/datastatistiksuratdinas" class="nav-link" style="display: flex; align-items: center;">
        <i class="bi bi-bar-chart-line nav-icon" style="color: white; font-size: 16px; flex-shrink: 0;"></i>
        <p style="color: white; margin: 0 0 0 8px;">Statistik Perjalanan Dinas</p>
    </a>
</li>
