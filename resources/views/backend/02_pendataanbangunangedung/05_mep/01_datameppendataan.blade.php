        ...
        <div class="col-12 mb-4 mt-5">
            <div class="card shadow-sm border-0 animate__animated animate__fadeInUp">
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    ...
                    <h5 style="font-size: 16px;" class="mb-0">Informasi Data MEP Dokumen Bangunan Gedung </h5>
                </div>
                ...
                <div class="card-body bg-white rounded-3" style="background: linear-gradient(to bottom, #f8faff, #e6f0ff);">
                    <div class="row g-3">
                      ...
                      <a href="/bedatabgmebangunanupdate/{{ $pemilik->databgkepemilikan_id }}">
    ...
    @empty
        <div class="col-12" style="margin-top: 50px;">
            ...
            ">
                ...
                Data Informasi Dokumen MEP Bangunan Gedung Tidak Ditemukan !!
            </div>
    ...
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0">Informasi Permohonan Pengajuan</h5>
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/bedatabgmebangunandelete/" + encodeURIComponent(id);
