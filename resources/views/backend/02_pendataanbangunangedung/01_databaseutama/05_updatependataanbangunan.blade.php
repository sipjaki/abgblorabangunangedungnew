...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="tanggalinput" name="tanggalinput"
                   value="{{ old('tanggalinput', $data->tanggalinput ?? \Carbon\Carbon::now()->format('Y-m-d')) }}" readonly>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('namainstitusi') is-invalid @enderror"
                   id="namainstitusi" name="namainstitusi"
                   value="{{ old('namainstitusi', $data->namainstitusi ?? '') }}">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nopengesahanusaha') is-invalid @enderror"
                   id="nopengesahanusaha" name="nopengesahanusaha"
                   value="{{ old('nopengesahanusaha', $data->nopengesahanusaha ?? '') }}">
...
<div class="col-md-12 mt-4">
    <div class="row text-center">
        ...
        @php
            $foto = $data->$field ?? null;
            $pathPublic = public_path('uploads/' . ($foto ?? ''));
        @endphp
        <div class="col-md-3 mb-3">
            <div class="card shadow-sm">
                ...
                <div class="card-body p-2" style="min-height: 200px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                    ...
                    {{-- Input File Baru --}}
                    <input type="file" class="form-control mb-2" name="{{ $field }}" id="{{ $field }}" accept="image/*"
                           onchange="previewImage(event, 'preview{{ $field }}')">

                    {{-- Preview Lama --}}
                    @if($foto && file_exists($pathPublic))
                        <p class="text-muted mb-1"><small>Preview Lama:</small></p>
                        <img src="{{ asset('uploads/'.$foto) }}" class="img-fluid rounded mb-2" style="max-height: 120px; object-fit: cover;">
                    @else
                        <div class="berkas-button text-muted mb-2" style="padding: 20px 10px;">
