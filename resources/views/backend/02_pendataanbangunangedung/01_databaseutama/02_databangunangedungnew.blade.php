    ...
    function searchTable() {
        ...
        fetch(url)
            ...
            .catch(error => console.error("Gagal ambil data:", error));
                        ...
                        <div style="position: relative; display: inline-block; margin-right:10px;">
                            <input type="search" id="searchInput" placeholder="Cari Data Bangunan Gedung ...." onkeyup="searchTable()" style="border: 1px solid #ccc; padding: 10px 20px; font-size: 14px; border-radius: 10px; width: 300px;">
                        ...
                        <script>
                            ...
                            fetch(`/bebangunangedung?search=${input}`)
                                .then(response => response.text())
                                .then(html => {
...
<div style="display: flex; justify-content: flex-end;">
  <a href="/404" class="text-decoration-none">
    <div class="button-newdata d-flex align-items-center justify-content-center px-3 py-2 shadow-sm">
        <i class="bi bi-bar-chart-line-fill me-2"></i> Statistik Per Kecamatan
    </div>
</a>
    ...
    >
        <i class="bi bi-plus-square me-2"></i> Buat Data Baru
    </div>
</a>
