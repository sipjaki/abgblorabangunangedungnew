...
[
    ...
    'value' => $pemilik->luaslantaildasar
        ? number_format((float) $pemilik->luaslantaildasar, 0, ',', '.') . ' M²'
        : '-',
],
[
    ...
    'value' => $pemilik->totalluaslantai
        ? number_format((float) $pemilik->totalluaslantai, 0, ',', '.') . ' M²'
        : '-',
],
[
...
[
    ...
    'value' => $pemilik->luasbasement
        ? number_format((float) $pemilik->luasbasement, 0, ',', '.') . ' M²'
        : '-',
],
    ...
    @empty
        <div class="col-12" style="margin-top: 50px;">
            ...
            ">
                ...
                Data Informasi Profil Bangunan Gedung Tidak Ditemukan !!
            </div>

            {{-- Tombol Tambah Data --}}
            <div class="text-center mt-4">
           <a href="{{ route('bedatabgprofilbangunancreate', $data->id) }}" class="button-hijau">
