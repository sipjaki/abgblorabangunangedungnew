...
<br>
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                  <form action="{{ route('datanewkicdokumennew') }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('POST')
                            <!-- begin::Body -->
<!-- Menyimpan ID kicinduk dari route -->
<input type="hidden" name="kicinduk_id" value="{{ $kicinduk_id }}">
...
<h5 class="mt-4 mb-3 fw-bold text-primary d-flex align-items-center"
    ...
    Data Baru KIC Dokumen Pendataan Bangunan Gedung Kabupaten Blora
</h5>
{{-- Nama Penginput (User ID Otomatis) --}}
{{-- Jenis Barang --}}
<div class="col-md-6">
    <div class="mb-3">
        <label class="form-label" for="jenisbarang">
            <i class="bi bi-box-seam me-2 text-primary"></i> Jenis Barang
        </label>
        <input type="text" class="form-control @error('jenisbarang') is-invalid @enderror" id="jenisbarang" name="jenisbarang" value="{{ old('jenisbarang', $data->jenisbarang ?? '') }}">
        @error('jenisbarang') <div class="invalid-feedback">{{ $message }}</div> @enderror
    </div>
</div>
...
<div class="col-md-6">
    <div class="mb-3">
        <label class="form-label" for="kodebarang">
            <i class="bi bi-upc-scan me-2 text-success"></i> Kode Barang
        </label>
        <input type="text" class="form-control @error('kodebarang') is-invalid @enderror" id="kodebarang" name="kodebarang" value="{{ old('kodebarang', $data->kodebarang ?? '') }}">
...
<div class="col-md-6">
    <div class="mb-3">
        <label class="form-label" for="register">
            <i class="bi bi-journal-text me-2 text-info"></i> Register
        </label>
        <input type="text" class="form-control @error('register') is-invalid @enderror" id="register" name="register" value="{{ old('register', $data->register ?? '') }}">
...
<div class="col-md-6">
    <div class="mb-3">
        <label class="form-label" for="luaslantai">
            <i class="bi bi-aspect-ratio-fill me-2 text-success"></i> Luas Lantai (m²)
        </label>
        <input type="number" step="0.01" class="form-control @error('luaslantai') is-invalid @enderror" id="luaslantai" name="luaslantai" value="{{ old('luaslantai', $data->luaslantai ?? '') }}">
        @error('luaslantai') <div class="invalid-feedback">{{ $message }}</div> @enderror
    </div>
</div>
