...
@php
    $infoItems = [
        ...
        [
            ...
            'title' => 'No. IMB/PBG',
            'value' => $pemilik->no_imbpbg ?? '-',
        ],
        [
            'icon' => 'bi-patch-check',
            'title' => 'No. SLF',
            'value' => $pemilik->no_slf ?? '-',
        ],
    ];
@endphp
        ...
        <div class="col-12 mb-4 mt-5">
            <div class="card shadow-sm border-0 animate__animated animate__fadeInUp">
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    ...
                    <h5 style="font-size: 16px;" class="mb-0">Informasi Data Status Bangunan Gedung </h5>
                </div>
                ...
                <div class="card-body bg-white rounded-3" style="background: linear-gradient(to bottom, #f8faff, #e6f0ff);">
                    <div class="row g-3">
                      ...
                      <a href="/bedatabgstatusbangunanupdate/{{ $pemilik->databgkepemilikan_id }}">
    ...
    @empty
        <div class="col-12" style="margin-top: 50px;">
            ...
            ">
                ...
                Data Informasi Status Bangunan Gedung Tidak Ditemukan !!
            </div>

            {{-- Tombol Tambah Data --}}
            <div class="text-center mt-4">
           <a href="{{ route('bedatabgstatuscreate', $data->id) }}" class="button-baru">
