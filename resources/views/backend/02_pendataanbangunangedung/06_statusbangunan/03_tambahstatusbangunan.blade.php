...
<div class="text-center">
   ...
   <h5 class="text-primary fw-bold mt-2" style="font-size: 16px;">
    ...
    Informasi Data Status Bangunan Gedung
</h5>
</h5>
    <hr class="my-4" style="border-top: 2px dashed #0d6efd; width: 60%; margin: auto;">
</div>

<form id="formPemilik" action="{{ route('bedatabgstatuscreatenew') }}" method="POST">
    @csrf
    ...
    <div class="row g-3 mt-2">
        {{-- Luas Tanah --}}
      <div class="col-md-6">
    <label class="form-label"><i class="bi bi-file-earmark-text text-primary me-1"></i> Dokumen Teknis Tanah</label>
    <input type="text" name="dokumen_teknis_tanah" class="form-control @error('dokumen_teknis_tanah') is-invalid @enderror" value="{{ old('dokumen_teknis_tanah') }}">
...
<div class="col-md-6">
    ...
    <input type="text" name="no_imbpbg" class="form-control @error('no_imbpbg') is-invalid @enderror" value="{{ old('no_imbpbg') }}">
    @error('no_imbpbg')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>

<div class="col-md-6">
    <label class="form-label"><i class="bi bi-file-earmark-lock text-primary me-1"></i> No. SLF</label>
    <input type="text" name="no_slf" class="form-control @error('no_slf') is-invalid @enderror" value="{{ old('no_slf') }}">
