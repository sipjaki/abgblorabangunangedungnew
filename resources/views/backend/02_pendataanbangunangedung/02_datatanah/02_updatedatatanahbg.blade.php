...
<div class="text-center">
   ...
   <h5 class="text-primary fw-bold mt-2" style="font-size: 16px;">
    ...
    Perbaikan Informasi Status Data Tanah Pendataan Bangunan Gedung
</h5>
</h5>
    <hr class="my-4" style="border-top: 2px dashed #0d6efd; width: 60%; margin: auto;">
</div>

<form id="formPemilik" action="{{ route('bedatabgprofiltanahupdatenew', $databangunan->id) }}" method="POST">
    @csrf
    @method('PUT')
