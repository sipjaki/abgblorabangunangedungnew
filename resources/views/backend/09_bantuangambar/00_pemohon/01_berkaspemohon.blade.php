    ...
    fetch(`/datadesablora?search=${input}`)
      ...
      .catch(error => console.error("Error fetching search results:", error));
        ...
        <th style=""><i class="bi bi-user"></i> Kelurahan/Desa</th>
            ...
            <th style=""><i class="bi bi-cpu"></i> Dokumen Gambar Saudara </th>
...
<script>
    function openModal(itemId) {
        ...
        form.action = `/verifikasi1permohonan/${itemId}`;
...
<script>
    function openModal2(itemId) {
        ...
        form.action = `/verifikasi1permohonan2/${itemId}`;
...
<script>
    function openModal3(itemId) {
        ...
        form.action = `/verifikasi1permohonan3/${itemId}`;
...
<td style="text-align: center;">
     ...
     <a href="{{ route('bebantuangambarupload', $item->id) }}"
                    class="button-berkas">
                    <i class="bi bi-eye" style="margin-right: 5px;"></i> Dokumen
                </a>
...
<script>
    function openModal4(itemId) {
        ...
        form.action = `/verifikasi1permohonan4/${itemId}`;
