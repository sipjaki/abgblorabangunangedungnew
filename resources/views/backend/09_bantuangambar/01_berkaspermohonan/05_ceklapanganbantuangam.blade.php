...
<button class="button-baru" type="button"
    onclick="location.href='/bebantuangambarlapcreate/{{ $data->id }}';"
    style="cursor: pointer; margin-left:10px; color:black;">
    <i class="bi bi-file-earmark-plus" style="margin-right: 5px;"></i> Buat Dokumentasi
</button>

<a href="{{ url('/bebantuangambar') }}" class="button-newvalidasi" style="cursor: pointer; color:black; margin-left:5px; display: inline-flex; align-items: center; text-decoration: none;">
    <i class="bi bi-arrow-left" style="margin-right: 5px;"></i> Kembali
</a>
        @endcanany
...
<th style="background-color: #ADD8E6; width:75px;"><i class="bi bi-journal-text"></i> Nama Kegiatan</th>
...
<td>
    <div style="margin-top: 10px;">
        {{-- Berkas Dukung 1 --}}
        @if($item->berkasdukung1 && file_exists(public_path('storage/' . $item->berkasdukung1)))
        <a href="{{ asset('storage/' . $item->berkasdukung1) }}" target="_blank" class="button-baru">
            <i class="bi bi-file-earmark-pdf-fill"></i> Lihat Berkas Dukung 1
        </a>
        @elseif($item->berkasdukung1)
        <a href="{{ asset($item->berkasdukung1) }}" target="_blank" class="button-baru">
            <i class="bi bi-file-earmark-pdf-fill"></i> Lihat Berkas Dukung 1
        </a>
        @else
...
<td>
    <div style="margin-top: 10px;">
        {{-- Berkas Dukung 1 --}}
        @if($item->berkasdukung2 && file_exists(public_path('storage/' . $item->berkasdukung2)))
        <a href="{{ asset('storage/' . $item->berkasdukung2) }}" target="_blank" class="button-baru">
            <i class="bi bi-file-earmark-pdf-fill"></i> Lihat Berkas Dukung 2
        </a>
        @elseif($item->berkasdukung2)
        <a href="{{ asset($item->berkasdukung2) }}" target="_blank" class="button-baru">
            <i class="bi bi-file-earmark-pdf-fill"></i> Lihat Berkas Dukung 2
        </a>
        @else
...
function setDeleteUrl(button) {
    ...
    var deleteUrl = "/bebantuangambarlapdelete/" + encodeURIComponent(id);
