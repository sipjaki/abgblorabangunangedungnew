...
<div class="card-header">
    ...
    <div style="display: flex; justify-content: flex-end; margin-bottom:5px;">
        <button class="button-newvalidasi"
                type="button"
                onclick="location.href='{{ route('bebantuangambar.index') }}';"
...
<hr>
    ...
    <h5 style="color: navy; font-weight:800; font-size:16px;">I. INFORMASI PERMOHONAN BANTUAN GAMBAR</h4>
...
<br>
    ...
    <h5 style="color: navy; font-weight:800; font-size:16px;">II. KELENGKAPAN BERKAS PERSYARATAN PERMOHONAN BANTUAN GAMBAR</h4>
    {{-- <h5>KEPALA DINAS</h5> --}}
    <div class="table-responsive">
...
<td style="text-align: center; font-size:16px;">
    <i class="bi bi-card-heading" style="margin-right:6px;"></i> KTP/<span style="color: red;">KITAS**</span>
</td>

<!-- Surat Pengajuan -->
<td style="text-align: center; font-size:16px;">
    <i class="bi bi-envelope-paper" style="margin-right:6px;"></i> Surat Pengajuan
</td>

<!-- Keterangan Rencana Kota -->
<td style="text-align: center; font-size:16px;">
    <i class="bi bi-map" style="margin-right:6px;"></i> Sertifikat Tanah
</td>
    ...
    <div style="margin-top: 10px;">
        @php
            $filePath = $data->ktp;
            $isPdf = $filePath && str_ends_with(strtolower($filePath), '.pdf');
        @endphp

        @if ($isPdf && file_exists(public_path('storage/' . $filePath)))
            <!-- Jika file PDF di storage -->
            <iframe
        ...
        @elseif($filePath)
            <!-- Jika file bukan PDF -->
            <p style="color: red;">data tidak ditemukan, silahkan lakukan perbaikan</p>
        @else
            <!-- Jika tidak ada file -->
            <p>data tidak ditemukan, silahkan lakukan perbaikan</p>
        @endif
    </div>
</td>
<td style="text-align: center;">
    <div style="margin-top: 10px;">
        @php
            $npwpPath = $data->npwp;
            $isPdfNpwp = $npwpPath && str_ends_with(strtolower($npwpPath), '.pdf');
        @endphp

        @if ($isPdfNpwp && file_exists(public_path('storage/' . $npwpPath)))
            <!-- Jika file PDF disimpan di storage -->
            <iframe
                src="{{ asset('storage/' . $npwpPath) }}"
                frameborder="0"
                style="transform: scale(0.8); transform-origin: top left; width: 125%; height: 500px;">
            </iframe>
        @elseif ($isPdfNpwp)
            <!-- Jika file PDF disimpan langsung di public -->
            <iframe
                src="{{ asset($npwpPath) }}"
                frameborder="0"
                style="transform: scale(0.8); transform-origin: top left; width: 125%; height: 500px;">
        ...
        @elseif ($npwpPath)
            <!-- File ada tapi bukan PDF -->
            <p style="color: red;">File bukan format PDF</p>
        @else
            <!-- Tidak ada file -->
            <p>data tidak ditemukan, silahkan lakukan perbaikan</p>
        @endif
    ...
    <table class="zebra-table table-striped">
        <tr>
<td style="text-align: center; font-size:16px;">
    <i class="bi bi-file-earmark-bar-graph" style="margin-right:6px;"></i> Keterangan Rencana Kota
</td>

<td style="text-align: center; font-size:16px;">
    <i class="bi bi-file-earmark-bar-graph" style="margin-right:6px;"></i> Bukti PBB/ Pajak Bumi
</td>

<td style="text-align: center; font-size:16px;">
    <i class="bi bi-receipt-cutoff" style="margin-right:6px;"></i> Surat Sewa Lahan / Berkas Dukung Lain
    {{-- <i class="bi bi-check2-square" style="margin-right:6px;"></i> Bukti Dukung Tata Ruang --}}
</td>
...
<td style="text-align: center; font-size:16px;">
    <i class="bi bi-map" style="margin-right:6px;"></i> Nomor Induk Berusaha
</td>

<td style="text-align: center; font-size:16px;">
    <i class="bi bi-pencil-square" style="margin-right:6px;"></i> Berkas Dukung Tata Ruang
</td>
...
<form action="{{ route('bebantuangambarvalidasi', $data->id) }}" method="POST">
    @csrf
    @method('PUT')
                    <!-- /.card-header -->
...
<div class="modal-body text-left">
    @if ($data->ktp)
        ...
        @else
            <p style="color: red; font-weight: bold;">data tidak ditemukan, silahkan lakukan perbaikan.</p>
        @endif
    @else
        <p style="color: red; font-weight: bold;">data tidak ditemukan, silahkan lakukan perbaikan.</p>
    @endif
...
@endcanany
                                    ...
                                    <tr>
                                       <th style="width: 400px; text-align:left; font-size: 16px; background-color: #e2e8f0; color: black;">
    <i class="bi bi-file-earmark-person-fill"></i> Surat Pengajuan
</th>
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <img src="/assets/abgblora/logo/logokabupatenblora.png" width="25" class="me-2">
                                                            <img src="/assets/icon/pupr.png" width="25" class="me-2">
                                                            <h5 class="modal-title" id="modalFotoLbl{{ $data->id }}">Surat Pengajuan</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                        </div>
<div class="modal-body text-left">
    @if ($data->npwp)
...
@endcanany
                                    ...
                                    <tr>
                                        <th style="width: 400px; text-align:left; font-size: 16px; background-color: #e2e8f0; color: black;">
    <i class="bi bi-briefcase-fill"></i> Keterangan Rencana Kota
</th>
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <img src="/assets/abgblora/logo/logokabupatenblora.png" width="25" class="me-2">
                                                                <img src="/assets/icon/pupr.png" width="25" class="me-2">
                                                                <h5 class="modal-title" id="modalLampiranossLbl{{ $data->id }}">Keterangan Rencana Kota .pdf</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                            </div>
                                                            <div class="modal-body text-center">
                                                                <div style="margin-top: 10px;">
...
@endcanany
                                    ...
                                    <tr>
                                        <th style="width: 400px; text-align:left; font-size: 16px; background-color: #e2e8f0; color: black;">
    <i class="bi bi-check2-square"></i> Surat Sewa Lahan/ Berkas Dukung Lainnya
</th>
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <img src="/assets/abgblora/logo/logokabupatenblora.png" width="25" class="me-2">
                                                                <img src="/assets/icon/pupr.png" width="25" class="me-2">
                                                                <h5 class="modal-title" id="modalValdpuprLbl{{ $data->id }}">Surat Sewa Lahan .pdf</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                            </div>
                                                            <div class="modal-body text-center">
                                                                <div style="margin-top: 10px;">
...
@endcanany
                                    ...
                                    <tr>
                                        <th style="width: 400px; text-align:left; font-size: 16px; background-color: #e2e8f0; color: black;">
    <i class="bi bi-map-fill"></i> Nomor Induk Berusaha
</th>
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <img src="/assets/abgblora/logo/logokabupatenblora.png" width="25" class="me-2">
                                                                <img src="/assets/icon/pupr.png" width="25" class="me-2">
                                                                <h5 class="modal-title" id="modalSiteplanLbl{{ $data->id }}">Nomor Induk Berusaha .pdf</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                            </div>
                                                            <div class="modal-body text-center">
                                                                <div style="margin-top: 10px;">
...
@endcanany
                                    ...
                                    <tr>
                                      <th style="width: 400px; text-align:left; font-size: 16px; background-color: #e2e8f0; color: black;">
                                            <i class="bi bi-file-earmark-text-fill"></i> Berkas Dukung Tata Ruang
                                        </th>
                                                    ...
                                                    <div class="modal-dialog modal-xl modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <img src="/assets/abgblora/logo/logokabupatenblora.png" width="25" class="me-2">
                                                                <img src="/assets/icon/pupr.png" width="25" class="me-2">
                                                                <h5 class="modal-title" id="modalTandatanganLbl{{ $data->id }}">Berkas Dukung Tata Ruang</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                            </div>
                                                            <div class="modal-body text-center">
                                                                <div style="margin-top: 10px;">
