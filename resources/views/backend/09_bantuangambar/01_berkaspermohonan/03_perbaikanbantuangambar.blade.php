...
<br>
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                  <form action="{{ route('bebantuangambarperbaikannew', $data->id) }}" method="POST" enctype="multipart/form-data">
          @csrf
                            <!-- begin::Body -->
                            <div class="card-body">
                                <div class="row">
...
<div class="col-md-6">
    <div class="mb-3">
        <label class="form-label" for="luasbangunan">
            <i class="bi bi-aspect-ratio" style="margin-right: 8px; color: navy;"></i>
            Luas Bangunan (m²)

            @if(!empty($data->luasbangunan))
                <span style="font-weight: normal; color: gray; font-size: 12px;">
                    — Data sebelumnya: {{ $data->luasbangunan }} m²
                </span>
            @endif
        </label>
...
<div class="text-center">
    ...
    <h5 style="color: #0d6efd; font-weight: bold; margin-top: 5px; font-size:16px;">
        ...
        Upload Perbaikan Berkas Permohonan Bantuan Gambar
    </h5>
    <hr class="my-4" style="border-top: 2px dashed #0d6efd; width: 60%; margin: auto;">
</div>
...
<div class="mb-3">
    <label class="form-label" for="npwp">
        <i class="bi bi-file-earmark-pdf" style="color: darkred; margin-right: 8px;"></i> Upload Surat Pengajuan(PDF)
    </label>
    ...
    <div id="msgNPWP" class="mt-3"
        ...
        Data belum di update. Silahkan upload Surat Pengajuan.
    </div>
</div>
...
<div class="col-md-6">
    ...
    <div class="mt-3" id="previewContainerST" style="{{ isset($data->sertifikattanah) ? '' : 'display: none;' }}">
        ...
        Data belum di update. Silahkan upload Surat Sertifikat Tanah.
    </div>
</div>

<div class="mb-3">
    <label class="form-label" for="lampiranoss">
        <i class="bi bi-file-earmark-pdf" style="color: darkred; margin-right: 8px;"></i> Upload Keterangan Rencana Kota (PDF)
    </label>
    ...
    <div class="mt-3" id="previewContainerOSS" style="{{ isset($data->lampiranoss) ? '' : 'display: none;' }}">
        ...
        Data belum di update. Silahkan upload berkas Keterangan Rencana Kota.
    </div>
</div>
...
<div class="col-md-6">
    ...
    <div class="mb-3">
        <label class="form-label" for="dokvalidasi">
            <i class="bi bi-file-earmark-pdf" style="color: darkred; margin-right: 8px;"></i> Upload Dokumen Surat Sewa Lahan(PDF)
        </label>
        ...
        <div class="mt-3" id="previewContainerVAL" style="{{ isset($data->dokvalidasi) ? '' : 'display: none;' }}">
            ...
            Data belum di update. Silahkan upload Dokumen Surat Sewa Lahan.
        </div>
    </div>
...
<div class="col-md-6">
    ...
    <label class="form-label" for="siteplan">
        <i class="bi bi-file-earmark-pdf" style="color: darkred; margin-right: 8px;"></i> Upload Nomor Induk Berusaha (PDF)
    </label>
    ...
    <div id="msgSITE" class="mt-3"
        ...
        Data belum di update. Silahkan upload berkas Nomor Induk Berusaha.
    </div>
</div>
<div class="mb-3">
    <label class="form-label" for="tandatangan">
        <i class="bi bi-file-earmark-pdf" style="color: darkred; margin-right: 8px;"></i> Upload Dokumen Kajian Tata Ruang (PDF)
    </label>
    ...
    <div id="msgTTD" class="mt-3"
        ...
        Data belum di update. Silahkan upload berkas Dokumen Kajian Tata Ruang.
    </div>
                                ...
                                <div id="confirmModal" style="display: none; position: fixed; inset: 0; background-color: rgba(0, 0, 0, 0.5); z-index: 1000; justify-content: center; align-items: center;">
                                    <div style="background: white; padding: 24px 30px; border-radius: 12px; max-width: 400px; width: 90%; text-align: center; box-shadow: 0 10px 25px rgba(0,0,0,0.2);">
                                      <p style="font-size: 16px; font-weight: 600; margin-bottom: 20px;">
                                        Apakah Anda ingin memperbaiki berkas permohonan bantuan gambar ini  ?
                                    </p>
