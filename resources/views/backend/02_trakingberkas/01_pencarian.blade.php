...
<head>
    ...
    <title>Pencarian Berkas Permohonan PBG/SLF - Sistem Informasi Pembina Jasa Konstruksi Kabupaten Blora</title>
    ...
    <meta name="description" content="Sistem Informasi Pembina Jasa Konstruksi Kabupaten Blora Provinsi Jawa Tengah" />
    <meta name="keywords" content="Sistem Informasi Pembina Jasa Konstruksi Kabupaten Blora Provinsi Jawa Tengah" />
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="container py-4">
                            ...
                            <form method="GET" action="{{ route('betracking') }}" class="row g-3 justify-content-center mb-4">
                                <div class="col-md-6">
                                    <input type="text" name="noregissimbg" id="noregissimbg"
                                           ...
                                           value="{{ request('noregissimbg') }}" required>
                                    @error('noregissimbg')
                            ...
                            @if(isset($data) && $data)
                                ...
                                <!-- Include fitur tambahan jika data ditemukan -->
