...
<table style="width: 100%; border-collapse: collapse; font-size: 12px;">
  ...
  <tr>
    <td style="{{ $cellStyle }}"></td>
    <td style="{{ $cellStyle }}" align="center"><strong>Nama Lengkap</strong></td>
      ...
      <table style="width: 100%; border-collapse: collapse;">
        <tr>
          <td style="width: 50%; vertical-align: top;">
            ...
            <div style="margin-top: 40px; font-weight: bold; font-size:12px;">MUHAMMAD YUSUF ZAQIE, SE</div>
          ...
          <td style="width: 50%; text-align: center;">
            ...
            <div style="font-weight: bold; font-size:12px;">MOHAMAD ARIF HIDAYAT, ST</div>
            <div style="font-size: font-size:12px;">NIP 19710508 199803 1 011</div>
          </td>
        </tr>
      </table>
    </div>
