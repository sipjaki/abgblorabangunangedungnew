...
<br>
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
          <form action="{{ route('bedinaspetugasnewupdate', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
                            <!-- begin::Body -->
<div class="row">
    <div class="col-md-6">
        ...
        <div class="mb-3">
            <label class="form-label" for="user_id">
                <i class="bi bi-person-check" style="margin-right: 8px; color: navy;"></i> Pilih Akun
            </label>
        ...
        <div class="mb-3">
            <label class="form-label" for="nip">
                <i class="bi bi-card-heading" style="margin-right: 8px; color: navy;"></i> NIP
            </label>
    ...
    <div class="col-md-6">
        {{-- Pangkat --}}
        <div class="mb-3">
            <label class="form-label" for="pangkat">
                <i class="bi bi-award" style="margin-right: 8px; color: navy;"></i> Pangkat
            </label>
        ...
        {{-- Tingkat Biaya --}}
        <div class="mb-3">
    <label class="form-label" for="tingkatbiaya">
        <i class="bi bi-cash-stack" style="margin-right: 8px; color: navy;"></i> Tingkat Biaya
    </label>
    <select id="tingkatbiaya" name="tingkatbiaya" class="form-select @error('tingkatbiaya') is-invalid @enderror">
        <option value="">-- Pilih Tingkat Biaya (A s.d. H) --</option>
        @foreach (range('A', 'H') as $huruf)
            <option value="{{ $huruf }}" {{ old('tingkatbiaya', $data->tingkatbiaya ?? '') == $huruf ? 'selected' : '' }}>
                {{ $huruf }}
            </option>
        @endforeach
    </select>
                                ...
                                <div id="confirmModal" style="display: none; position: fixed; inset: 0; background-color: rgba(0, 0, 0, 0.5); z-index: 1000; justify-content: center; align-items: center;">
                                    <div style="background: white; padding: 24px 30px; border-radius: 12px; max-width: 400px; width: 90%; text-align: center; box-shadow: 0 10px 25px rgba(0,0,0,0.2);">
                                      <p style="font-size: 16px; font-weight: 600; margin-bottom: 20px;">
                                        Apakah Anda ingin menambahkan petugas dinas ?
                                    </p>
