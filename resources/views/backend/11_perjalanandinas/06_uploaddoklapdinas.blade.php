...
<br>
        ...
        {{-- ======================================================= --}}
                    <div class="col-md-12">
                        <!--begin::Quick Example-->
                  <form action="{{ route('dataalldinassuratdokcreatenew') }}" method="POST" enctype="multipart/form-data">
          @csrf

<input type="hidden" name="perjalanandinas_id" value="{{ $data->id }}">
...
<div class="col-md-6">
    <div class="mb-3">
        <label class="form-label" for="dinasluasdalam">
            <i class="bi bi-building" style="margin-right: 8px; color: navy;"></i> Status Perjalanan Dinas
        </label>
        <input
            type="text"
            id="dinasluasdalam"
            name="dinasluasdalam"
            value="{{ old('dinasluasdalam', $data->dinasluasdalam ?? '') }}"
            class="form-control @error('dinasluasdalam') is-invalid @enderror"
...
<div class="col-md-6">
    <div class="mb-3">
        <label class="form-label" for="tanggalsuratterbit">
            <i class="bi bi-calendar-event" style="margin-right: 8px; color: navy;"></i> Tanggal Surat Terbit
        </label>
        <input
            type="date"
            id="tanggalsuratterbit"
            name="tanggalsuratterbit"
  ...
  <div class="col-md-6">
    <div class="mb-3">
      <label class="form-label" for="namakegiatan">
        <i class="bi bi-journal-text" style="margin-right: 8px; color: navy;"></i> Nama Kegiatan
      </label>
      <input
        type="text"
        id="namakegiatan"
  ...
  <div class="col-md-6">
    <div class="mb-3">
      <label class="form-label" for="foto1">
        <i class="bi bi-image" style="color: darkgreen; margin-right: 8px;"></i> Upload Foto 1
      </label>
      ...
      <div class="mt-3" id="previewFoto1" style="display: none;">
        <img src="" class="img-fluid rounded border" style="max-height: 300px;" />
      </div>
      <div id="msgFoto1" class="mt-2 text-muted" style="font-style: italic;">
        Belum upload gambar, silakan upload Foto 1.
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6">
    <div class="mb-3">
      <label class="form-label" for="foto2">
        <i class="bi bi-image" style="color: darkgreen; margin-right: 8px;"></i> Upload Foto 2
      </label>
      ...
      <div class="mt-3" id="previewFoto2" style="display: none;">
        <img src="" class="img-fluid rounded border" style="max-height: 300px;" />
      </div>
      <div id="msgFoto2" class="mt-2 text-muted" style="font-style: italic;">
        Belum upload gambar, silakan upload Foto 2.
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6">
    <div class="mb-3">
      <label class="form-label" for="foto3">
        <i class="bi bi-image" style="color: darkgreen; margin-right: 8px;"></i> Upload Foto 3
      </label>
      ...
      <div class="mt-3" id="previewFoto3" style="display: none;">
        <img src="" class="img-fluid rounded border" style="max-height: 300px;" />
      </div>
      <div id="msgFoto3" class="mt-2 text-muted" style="font-style: italic;">
        Belum upload gambar, silakan upload Foto 3.
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6">
    <div class="mb-3">
      <label class="form-label" for="foto4">
        <i class="bi bi-image" style="color: darkgreen; margin-right: 8px;"></i> Upload Foto 4
      </label>
      ...
      <div class="mt-3" id="previewFoto4" style="display: none;">
        <img src="" class="img-fluid rounded border" style="max-height: 300px;" />
      </div>
      <div id="msgFoto4" class="mt-2 text-muted" style="font-style: italic;">
        Belum upload gambar, silakan upload Foto 4.
      </div>
    </div>
  </div>
  ...
  <div class="col-md-6">
    <div class="mb-3">
      <label class="form-label" for="foto5">
        <i class="bi bi-image" style="color: darkgreen; margin-right: 8px;"></i> Upload Foto 5
      </label>
      ...
      <div class="mt-3" id="previewFoto5" style="display: none;">
        <img src="" class="img-fluid rounded border" style="max-height: 300px;" />
      </div>
      <div id="msgFoto5" class="mt-2 text-muted" style="font-style: italic;">
        Belum upload gambar, silakan upload Foto 5.
      </div>
    </div>
  </div>
</div>
                                ...
                                <div id="confirmModal" style="display: none; position: fixed; inset: 0; background-color: rgba(0, 0, 0, 0.5); z-index: 1000; justify-content: center; align-items: center;">
                                    <div style="background: white; padding: 24px 30px; border-radius: 12px; max-width: 400px; width: 90%; text-align: center; box-shadow: 0 10px 25px rgba(0,0,0,0.2);">
                                      <p style="font-size: 16px; font-weight: 600; margin-bottom: 20px;">
                                        Apakah Anda ingin upload dokumentasi perjalanan dinas ini ?
                                    </p>
