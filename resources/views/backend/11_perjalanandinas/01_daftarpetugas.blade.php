...
<div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px; margin-bottom: 10px;">
  ...
  <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
    ...
    <a href="/bedinaspetugas" style="text-decoration: none;">
...
<th style="background-color: #ADD8E6;"><i class="fas fa-id-badge"></i> NIP</th>
...
{{-- <td>{{ $item->asosiasimasjaki->namaasosiasi ?? '-' }}</td> --}}
   ...
   <td>{{ $item->user->name ?? 'Data Masih Kosong' }}</td>
    <td>{{ $item->nip ?? 'Data Masih Kosong' }}</td>
            ...
            <td style="text-align: center; vertical-align: middle;">
                {{-- <a href="/404" class="btn btn-sm btn-info me-2" title="Show">
                    <i class="bi bi-eye"></i>
                                        ...
                                        <a href="{{ url('/bedinaspetugasupdate/' . $item->id) }}" class="btn btn-sm btn-warning me-2" title="Update">
                 ...
                 function setDeleteUrl(button) {
                     ...
                     var deleteUrl = "/bepetugasdinasdelete/" + encodeURIComponent(id);
