                ...
                <span style="font-family: 'Poppins', sans-serif;">📌 Halaman : {{$title}}</span>
                     ...
                     <div style="display: flex; justify-content: flex-end; margin-bottom: 5px;">
                        <div style="position: relative; display: inline-block; margin-right:10px;">
                            <input type="search" id="searchInput" placeholder="Cari Perjalanan Dinas ...." onkeyup="searchTable()" style="border: 1px solid #ccc; padding: 10px 20px; font-size: 14px; border-radius: 10px; width: 300px;">
...
{{-- <td>{{ $item->ketkegiatan }}</td> --}}
   ...
   <td style="text-align: center;">
    <div style="display: inline-flex; justify-content: center; align-items: center; gap: 10px;">
        <a href="{{ route('dataalldinassuratshow.detail', $item->id) }}"
            class="button-baru">
            <i class="fas fa-eye" style="margin-right: 5px;"></i> Surat Tugas
        </a>
...
<td style="text-align: center; display: flex; justify-content: center; align-items: center; height: 60px;">
        ...
        <a href="{{ route('dataalldinassuratlap.show', $item->id) }}"
                    class="button-baru">
                    <i class="fas fa-eye" style="margin-right: 5px;"></i> Dok Perjalanan
                </a>
...
<td style="text-align: center; vertical-align: middle; width: 100%;">
    ...
    <a href="{{ route('databadokdinasint', $item->id) }}"
        class="button-berkas">
