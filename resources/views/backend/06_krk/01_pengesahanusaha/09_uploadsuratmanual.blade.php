                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-header">
                            ...
                            <div style="display: flex; justify-content: flex-end; margin-bottom: 5px;">
                                @canany(['pemohon'])
                                    <button type="button" onclick="window.location.href='{{ url('/bekrkusahapemohon') }}';" class="button-modern">
                                        <i class="bi bi-arrow-left mr-2"></i> Kembali
                                    </button>
                                @endcanany

                                @canany(['superadmin', 'admin'])
                                    <button type="button" onclick="window.location.href='{{ url('/bekrkusaha') }}';" class="button-modern">
                                        <i class="bi bi-arrow-left mr-2"></i> Kembali
                                    </button>
                                @endcanany
                            </div>
