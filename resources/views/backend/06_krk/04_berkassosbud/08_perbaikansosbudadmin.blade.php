...
<br>
    ...
    <div class="form-modern col-md-6">
        <div class="mb-3">
            ...
            <input type="text" id="nomordinasasal" name="nomordinasasal"
                ...
                class="form-control @error('nomordinasasal') is-invalid @enderror"
                placeholder="Masukkan nomor dinas asal">
    ...
    <div class="form-modern col-md-6">
        <div class="mb-3">
            ...
            <input type="text" id="perorangan" name="perorangan"
                value="{{ old('perorangan', $data->perorangan ?? '') }}"
                class="form-control @error('perorangan') is-invalid @enderror"
                placeholder="Masukkan nama perorangan">
            @error('perorangan')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="form-modern col-md-6">
        <div class="mb-3">
            ...
            <input type="text" id="koordinatlokasi" name="koordinatlokasi"
                value="{{ old('koordinatlokasi', $data->koordinatlokasi ?? '') }}"
                class="form-control @error('koordinatlokasi') is-invalid @enderror"
    ...
    <div class="form-modern col-md-6">
        <div class="mb-3">
            <label class="form-label-modern" for="tanggalpermohonan">
                <i class="bi bi-calendar-date" style="margin-right: 8px; color: navy;"></i> Tanggal Permohonan
            </label>
            <input type="date" id="tanggalpermohonan" name="tanggalpermohonan"
                value="{{ old('tanggalpermohonan', $data->tanggalpermohonan ?? '') }}"
    ...
    <div class="form-modern col-md-6">
        <div class="mb-3">
            ...
            <input type="text" id="jumlahlantai" name="jumlahlantai"
    ...
    <!-- RT -->
    <div class="form-modern col-md-3">
        <div class="mb-3">
            <label class="form-label-modern" for="rt">
                <i class="bi bi-house" style="margin-right: 8px; color: navy;"></i> RT
            </label>
    ...
    <div class="form-modern col-md-3">
        <div class="mb-3">
            <label class="form-label-modern" for="rw">
                <i class="bi bi-house" style="margin-right: 8px; color: navy;"></i> RW
            </label>
    ...
    <div class="form-modern col-md-6">
        <div class="mb-3">
            ...
            <textarea id="lokasibangunan" name="lokasibangunan"
                ...
                placeholder="Masukkan lokasi bangunan">{{ old('lokasibangunan', $data->lokasibangunan ?? '') }}</textarea>
    ...
    <div class="form-modern col-md-12">
        <div class="mb-3">
            ...
            <textarea id="alamatpemohon" name="alamatpemohon"
                class="form-control @error('alamatpemohon') is-invalid @enderror"
                placeholder="Masukkan alamat pemohon">{{ old('alamatpemohon', $data->alamatpemohon ?? '') }}</textarea>
            @error('alamatpemohon')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
