...
Route::get('/betracking', [PbgslfController::class, 'betracking'])->middleware('auth','can:admindpupr')->name('betracking');
...
Route::post('/permohonanpengesahanusahacreate/{id}', [KrkController::class, 'permohonanpengesahanusahacreate'])->middleware('auth', 'can:admindpupr')->name('permohonan.pengesahanusahacreate');
...
Route::get('/bekrkusahapemohon', [KrkController::class, 'bekrkusahapemohon'])->middleware('auth', 'can:dinas-atau-pemohon')->name('bekrkusahapemohon.indexpemohon');
...
Route::get('/bekrkkeagamaanpemohon', [KrkController::class, 'bekrkkeagamaanpemohon'])->middleware('auth', 'can:dinas-atau-pemohon')->name('bekrkkeagamaanpemohon.indexpemohon');
...
Route::get('/bekrkshowpermohonan/{id}', [KrkController::class, 'bekrkshowpermohonan'])->middleware('auth', 'can:admindinas')->name('bekrkshowpermohonan.show');
...
Route::get('/dokuploadkrkagama/{id}', [KrkController::class, 'dokuploadkrkagama'])->middleware('auth', 'can:admindinas')->name('dokuploadkrkagama');
...
Route::get('/bekrkusahaperbaikan/{id}', [KrkController::class, 'bekrkusahaperbaikan'])->middleware('auth', 'can:admindinas')->name('bekrkusahaperbaikan.perbaikan');
...
// TANDA TANGAN KEPALA BIDANG BANGUNAN GEDUNG
Route::get('/kabidbangunangedung', [DatabaseAbgController::class, 'kabidbangunangedung'])->middleware(['auth', 'can:admindpupr'])->name('kabidbangunangedung');
// Route::get('/ttdkepaladinasbloraupdate/{id}', [DatabaseAbgController::class, 'ttdkepaladinasbloraupdate'])->middleware(['auth', 'can:admindpupr'])->name('ttdkepaladinasbloraupdate.update');
// Route::post('/ttdkepaladinasbloraupdatenew/{id}', [DatabaseAbgController::class, 'ttdkepaladinasbloraupdatenew'])->middleware('auth')->name('ttdkepaladinasbloraupdatenew.update');
...
Route::get('/bedatapetugaspenilik', [PenilikbangunanController::class, 'bedatapetugaspenilik'])->middleware('auth')->name('bedatapetugaspenilik'); // SUPER ADMIN DAN ADMIN
Route::get('/bedatapetugaspenilikcreate', [PenilikbangunanController::class, 'bedatapetugaspenilikcreate'])->middleware('auth')->name('bedatapetugaspenilikcreate'); // SUPER ADMIN DAN ADMIN
...
Route::get('/dokhibahbantuanberkas/{id}', [BantuanhibahbgController::class, 'dokhibahbantuanberkas'])->middleware('auth','can:admindpupr')->name('dokhibahbantuanberkas.show');

Route::get('/dokberkashibah/{id}', [BantuanhibahbgController::class, 'dokberkashibah'])->middleware('auth','can:admindpupr')->name('dokberkashibah.create');
...
Route::get('/dokuploadskhibah/{id}', [BantuanhibahbgController::class, 'dokuploadskhibah'])->middleware('auth', 'can:admindpupr')->name('dokuploadskhibah.show');

Route::get('/dokuploadhibahskcreate/{id}', [BantuanhibahbgController::class, 'dokuploadhibahskcreate'])->middleware('auth', 'can:admindpupr')->name('dokuploadhibahskcreate.create');
...
// DATA TEKNIS ARSITEKTUR
Route::get('/bepbgdokumeteknisstrk/{id}', [PbgslfController::class, 'bepbgdokumeteknisstrk'])->middleware('auth', 'can:admindpupr')->name('bepbgdokumeteknisstrk');
Route::get('/bepbgdokumeteknisstrkcreate/{id}', [PbgslfController::class, 'bepbgdokumeteknisstrkcreate'])->middleware('auth', 'can:admindpupr')->name('bepbgdokumeteknisstrkcreate');
Route::post('/bepbgdokumeteknisstrkcreatenew', [PbgslfController::class, 'bepbgdokumeteknisstrkcreatenew'])->middleware('auth', 'can:admindpupr')->name('bepbgdokumeteknisstrkcreatenew');
Route::delete('/bepbgdokumeteknisstrkdelete/{id}', [PbgslfController::class, 'bepbgdokumeteknisstrkdelete'])->middleware('auth', 'can:admindpupr')->name('bepbgdokumeteknisstrkdelete');
...
Route::get('/dokumenteknisslf/{id}', [PbgslfController::class, 'dokumenteknisslf'])->middleware('auth', 'can:admindpupr')->name('dokumenteknisslf');
Route::get('/dokumenteknisslfcreate/{id}', [PbgslfController::class, 'dokumenteknisslfcreate'])->middleware('auth', 'can:admindpupr')->name('dokumenteknisslfcreate');
Route::post('/dokumenteknisslfcreatenew', [PbgslfController::class, 'dokumenteknisslfcreatenew'])->middleware('auth', 'can:admindpupr')->name('dokumenteknisslfcreatenew');
Route::delete('/dokumenteknisslfdelete/{id}', [PbgslfController::class, 'dokumenteknisslfdelete'])->middleware('auth', 'can:admindpupr')->name('dokumenteknisslfdelete');
...
Route::post('/betpatptupdatenewcreate/{id}', [PbgslfController::class, 'betpatptupdatestore'])->middleware('auth', 'can:admindpupr')->name('update.betpatptupdatenew');
...
Route::get('/bepbgsuratpemberitahuan/{id}', [PbgslfController::class, 'bepbgsuratpemberitahuan'])->middleware('auth', 'can:admindpupr')->name('bepbgsuratpemberitahuan');
Route::delete('/bepbgsuratpemberitahuandel/{id}', [PbgslfController::class, 'bepbgsuratpemberitahuandel'])->middleware('auth', 'can:admindpupr')->name('bepbgsuratpemberitahuandel');
Route::get('/bepbgsuratpemberitahuancreate/{id}', [PbgslfController::class, 'bepbgsuratpemberitahuancreate'])->middleware('auth', 'can:admindpupr')->name('bepbgsuratpemberitahuancreate');
Route::post('/bepbgsuratnew', [PbgslfController::class, 'bepbgsuratnew'])->middleware('auth', 'can:admindpupr')->name('bepbgsuratnew');
...
Route::get('/bepbgsuratundangantpatpt/{id}', [PbgslfController::class, 'bepbgsuratundangantpatpt'])->middleware('auth', 'can:admindpupr')->name('bepbgsuratundangantpatpt');
Route::get('/bepbgsuratundangantpatptshow/{id}', [PbgslfController::class, 'bepbgsuratundangantpatptshow'])->middleware('auth', 'can:admindpupr')->name('bepbgsuratundangantpatptshow');

// DATA DOKUMEN SURAT PEMBERITAHUAN
Route::get('/bepbgsuratundangan/{id}', [PbgslfController::class, 'bepbgsuratundangan'])->middleware('auth','can:admindpupr')->name('bepbgsuratundangan');
Route::get('/bepbgsuratundangancreate/{id}', [PbgslfController::class, 'bepbgsuratundangancreate'])->middleware('auth','can:admindpupr')->name('bepbgsuratundangancreate');
Route::post('/bepbgsuratundangannew', [PbgslfController::class, 'bepbgsuratundangannew'])->middleware('auth','can:admindpupr')->name('bepbgsuratundangannew');

Route::get('/bepbgsuratundanganshow/{id}', [PbgslfController::class, 'bepbgsuratundanganshow'])->middleware('auth', 'can:admindpupr')->name('bepbgsuratundanganshow.detail');
Route::delete('/bepbgsuratundangandelete/{id}', [PbgslfController::class, 'bepbgsuratundangandelete'])->middleware('auth', 'can:admindpupr')->name('bepbgsuratundangandelete');
...
Route::post(
    '/bebantekanalisabgn/createnewbaru',
...
// PERBAIKAN INFORMASI BANGUNAN
    Route::get('/perbaikaninformasibangunangedung/{id}',[BantuanteknisController::class, 'perbaikandetailbangunangedung'])->middleware('auth', 'can:admindinas')->name('perbaikan.informasibangunangedung');
...
// Route::get('/newui', [NewUiController::class, 'index'])web->name('newui');
...
// Route::get('/bebantekpembongkaranall', [BantuanteknisController::class, 'bebantekpembongkaranall'])->middleware('auth', 'can:admindinas')->name('bebantekpembongkaran');
Route::get('/bebantekanalisakerusakan/create', [BantuanteknisController::class, 'bebantekanalisakerusakancreate'])->middleware('auth', 'can:admindinas')->name('bebantekanalisakerusakancreate');
Route::post(
    '/bebantekanalisakerusakan/createbaru',
    [BantuanteknisController::class, 'bebantekanalisakerusakancreatenew']
)->middleware('auth', 'can:admindinas')
...
Route::post('/bebantekkerusakan/create',[BantuanteknisController::class, 'bebantekkerusakancreatehitung'])->middleware('auth', 'can:admindinas')->name('bantekkerusakanhitungcreate');
