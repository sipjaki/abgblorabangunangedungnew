...
class KrkController extends Controller
{
    ...
    public function permohonankrkusahacreate(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'sertifikattanah' => 'nullable|file|mimes:pdf|max:10240',
            'lampiranoss' => 'nullable|file|mimes:pdf|max:5120',
            'buktipbb' => 'nullable|file|mimes:pdf|max:5120',
            'dokvalidasi' => 'nullable|file|mimes:pdf|max:5120',
            'siteplan' => 'nullable|file|mimes:pdf|max:10240',
            'tandatangan' => 'nullable|file|mimes:jpeg,png,jpg,pdf|max:2048',
