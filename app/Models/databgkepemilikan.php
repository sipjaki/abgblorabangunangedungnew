...
class databgkepemilikan extends Model
{
    ...
    public function databgpeprofilbangunangedung()
    {
    ...
    public function databgstrukturbangunan() // DIA ABAIKAN DULU
    {
        return $this->hasMany(databgstrukturbangunan::class);
    }

    public function databgstatus() // DIA ABAIKAN DULU
    {
    ...
    public function databgdokumenmepbangunan()
    {
        return $this->hasMany(databgdokumenmepbangunan::class);
    }
